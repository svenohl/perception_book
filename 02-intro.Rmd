...
![Figure. **a** Rotated black rectangle seems to occlude grey square. **b** Moving the two objects apart reveals the grey square. **c** Alternatively, moving the black rectangle away, could reveal a more complex grey object.](ch2_images/p_1_4.gif)
...
For next week, I would like to ask you to think about, and answer, the following three questions. Each answer should have a length of about 150 words.
